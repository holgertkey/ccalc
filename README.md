...
**Current version: 0.43.0** — see [CHANGELOG](CHANGELOG.md) for history.
...
| `clabel()` | `plot` | Enable level labels on the next `contour`/`contourf` render (ASCII: footer line; SVG/PNG: inline text per isoline) |
